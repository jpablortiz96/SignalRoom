...
export default function EvidencePage() {
  ...
  useEffect(() => {
    ...
    if (!trackedEvidenceView) {
      trackedEvidenceView = true;
      trackSignalRoomEvent("evidence_feed_viewed");
    }
  }, []);

  const handleFilterChange = (filter: typeof activeFilter) => {
    setActiveFilter(filter);
    trackSignalRoomEvent("evidence_filter_used", {
      activeFilter: filter,
  ...
  useEffect(() => {
    ...
    searchDebounceRef.current = setTimeout(() => {
      trackSignalRoomEvent("evidence_searched", {
          ...
          <>
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-8">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <button
                  onClick={() => handleFilterChange("Click")}
                  className={`rounded-lg px-3.5 py-1.5 text-xs font-semibold border transition-all ${
                    activeFilter === "Click" 
                      ? "bg-zinc-900 border-zinc-850 text-indigo-400 font-bold" 
                      : "bg-zinc-950 border-zinc-900 text-zinc-400 hover:border-zinc-800"
                ...
                <button
                  onClick={() => handleFilterChange("Friction")}
                  className={`rounded-lg px-3.5 py-1.5 text-xs font-semibold border transition-all ${
                ...
                <button
                  onClick={() => handleFilterChange("Understanding")}
                  className={`rounded-lg px-3.5 py-1.5 text-xs font-semibold border transition-all ${
